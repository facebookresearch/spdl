...
@overload
def convert_frames(frames: FFmpegAudioFrames, pin_memory: bool = False) -> CPUBuffer: ...

@overload
def convert_frames(frames: FFmpegVideoFrames, pin_memory: bool = False) -> CPUBuffer: ...

@overload
def convert_frames(frames: FFmpegImageFrames, pin_memory: bool = False) -> CPUBuffer: ...

@overload
def convert_frames(frames: Sequence[FFmpegAudioFrames], pin_memory: bool = False) -> CPUBuffer: ...

@overload
def convert_frames(frames: Sequence[FFmpegVideoFrames], pin_memory: bool = False) -> CPUBuffer: ...

@overload
def convert_frames(frames: Sequence[FFmpegImageFrames], pin_memory: bool = False) -> CPUBuffer: ...
...
@overload
def demux_audio(src: str, *, timestamp: tuple[float, float] | None = None, demux_config: DemuxConfig | None = None, bsf: str | None = None, _adaptor: SourceAdaptor | None = None) -> AudioPackets: ...

@overload
def demux_audio(data: bytes, *, timestamp: tuple[float, float] | None = None, demux_config: DemuxConfig | None = None, bsf: str | None = None, _zero_clear: bool = False) -> AudioPackets: ...

@overload
def demux_image(src: str, *, demux_config: DemuxConfig | None = None, bsf: str | None = None, _adaptor: SourceAdaptor | None = None) -> ImagePackets: ...

@overload
def demux_image(data: bytes, *, demux_config: DemuxConfig | None = None, bsf: str | None = None, _zero_clear: bool = False) -> ImagePackets: ...

@overload
def demux_video(src: str, *, timestamp: tuple[float, float] | None = None, demux_config: DemuxConfig | None = None, bsf: str | None = None, _adaptor: SourceAdaptor | None = None) -> VideoPackets: ...

@overload
def demux_video(data: bytes, *, timestamp: tuple[float, float] | None = None, demux_config: DemuxConfig | None = None, bsf: str | None = None, _zero_clear: bool = False) -> VideoPackets: ...

@overload
def encode_image(path: str, data: Annotated[ArrayLike, dict(device='cpu', order='C')], *, pix_fmt: str = 'rgb24', encode_config: EncodeConfig | None = None) -> None: ...
