...
@overload
def decode_image_nvjpeg(data: memoryview, *, device_config: CUDAConfig, scale_width: int = -1, scale_height: int = -1, pix_fmt: str = 'rgb', sync: bool = True, _zero_clear: bool = False) -> CUDABuffer: ...
...
@overload
def decode_image_nvjpeg(data: Sequence[memoryview], *, device_config: CUDAConfig, scale_width: int, scale_height: int, pix_fmt: str = 'rgb', sync: bool = True, _zero_clear: bool = False) -> CUDABuffer: ...
