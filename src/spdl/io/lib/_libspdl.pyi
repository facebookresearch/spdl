...
class PacketsIterator:
    def __iter__(self) -> PacketsIterator: ...

    def __next__(self) -> dict[int, AudioPackets | VideoPackets | ImagePackets]: ...
...
class FrameArenaConfig:
    def __init__(self, initial_size: int = 134217728, max_size: int = 1073741824, granularity: int = 65536, max_free_per_bucket: int = 8) -> None: ...

class FrameArena:
    def __init__(self, config: FrameArenaConfig = ...) -> None: ...
...
@overload
def decode_packets(packets: AudioPackets, *, decode_config: DecodeConfig | None = None, filter_desc: str | None = None, num_frames: int = -1, arena: FrameArena | None = None) -> AudioFrames: ...

@overload
def decode_packets(packets: VideoPackets, *, decode_config: DecodeConfig | None = None, filter_desc: str | None = None, num_frames: int = -1, arena: FrameArena | None = None) -> VideoFrames: ...

@overload
def decode_packets(packets: ImagePackets, *, decode_config: DecodeConfig | None = None, filter_desc: str | None = None, num_frames: int = -1, arena: FrameArena | None = None) -> ImageFrames: ...
