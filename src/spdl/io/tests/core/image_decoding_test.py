...
from spdl.io.tests.fixture import (
    FFMPEG_CLI,
    get_sample,
    get_samples,
    load_ref_data,
...
class TestDecodeImage(unittest.TestCase):
    ...
    def test_decode_image_yuvj422_as_rgb24(self) -> None:
    ...
    def test_decode_image_yuvj420p_native(self) -> None:
    ...
    def test_decode_image_yuvj420p_as_rgb24(self) -> None:
    ...
    def test_decode_image_yuvj420p_as_rgb24_edge_values(self) -> None:
    ...
    def test_decode_image_yuvj444p_as_rgb24(self) -> None:
    ...
    def test_decode_image_nv12_native(self) -> None:
    ...
    @unittest.skipIf(
        get_ffmpeg_versions()["libavutil"][0] < 57,
        "Test requires FFmpeg libavutil >= 57",
    )
    def test_decode_image_nv12_as_rgb24(self) -> None:
...
class TestLoadImageBatch(unittest.TestCase):
    def test_load_image_batch_native(self) -> None:
        """`load_image_batch` can decode series of images."""
        cmd = f"{FFMPEG_CLI} -hide_banner -y -f lavfi -i testsrc -frames:v 32 sample_%03d.png"
        ...
        print(array.shape)
        self.assertEqual(array.shape, (n, h, w, 3))
    ...
    def test_load_image_batch_native_edge_values(self) -> None:
        """`load_image_batch` can decode series of images."""
        # fmt: off
        cmd = f"""
        {FFMPEG_CLI} -hide_banner -y                          \
        ...
        self.assertEqual(arr.shape, (n, h, 3 * w, 3))
    ...
    def test_batch_decode_image_handle_failure(self) -> None:
        ...
        cmd = f"{FFMPEG_CLI} -hide_banner -y -f lavfi -i testsrc -frames:v 32 sample_%03d.jpg"
        srcs = get_samples(cmd)
        ...
        self.assertEqual(buffer.__array_interface__["shape"], (32, 3, 240, 320))
