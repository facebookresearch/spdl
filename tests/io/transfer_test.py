...
class _Item:
    x: int
    y: int
    z: Union[int, "_Item"] = field(default=1, init=False)
...
class TestGpuTransfer(unittest.TestCase):
    ...
    def test_gpu_transfer(
        ...
        def _test():
            ...
            self.assertTrue(hasattr(spdl.io._transfer._THREAD_LOCAL, "transfer"))
