...
class TestDemuxConfig(unittest.TestCase):
    def test_demux_config_smoketest(self) -> None:
        """"""
    ...
    def test_demux_config_headless(self) -> None:
...
class TestDecodeConfig(unittest.TestCase):
    def test_decode_config_smoketest(self) -> None:
        """"""
