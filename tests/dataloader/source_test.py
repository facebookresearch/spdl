...
class SourceTest(unittest.TestCase):
    def test_LocalDirectory(self):
        ...
        with TemporaryDirectory() as root_dir:
            ...
            self.assertNotEqual(vals1, vals3)
            self.assertEqual(set(vals1), targets)
    ...
    def test_ImageNet(self):
        ...
        with TemporaryDirectory() as root_dir:
            ...
            self.assertEqual(set(v1), vals)
            self.assertEqual(set(v2), vals)
            ...
            v2 = list(src)
            self.assertNotEqual(v1, v2)
            self.assertEqual(set(v1), trains)
            self.assertEqual(set(v2), trains)
